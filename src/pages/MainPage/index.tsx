        ...
        <div className={`${styles.container} ${mobileSize ? styles.full : ""}`}>
          <div className={styles["about__container"]}>
            ...
            <p className={styles["about__text"]}>
              Вас вітає компанія очищення та доставки води «AQUALITE». Якість,
              відповідальність, зручність – це все про нас! Наша компанія
              пропонує воду, яку ми доставимо в ваш будинок або офіс, кафе або
              ресторан.
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              Вода "AQUALITE". виробляється на сучасному та якісному
              устаткуванні, яке дозволяє стежити за якістю води на всіх етапах
              її виробництва. Вода "AQUALITE" з нейтральним мінеральним складом,
              що нормалізує гідробаланс і сприяє її включення у всі процесії в
              організмі. Збалансований хімічний склад ідеально підходить для
          ...
          <div className={styles["about__container"]}>
            ...
            <p className={styles["about__text"]}>
              Власний автопарк дозволяє вчасно та без затримок привозити ваше
              замовлення. Ми завжди намагаємося входити в стан клієнта, тому
              підбираємо найбільш сприятливий та зручний час для доставки. З
              впевненістю говоримо, що питна Вода "AQUALITE" має помірну
              вартість за найкращу якість.
            </p>
          </div>
        </div>
      </section>
